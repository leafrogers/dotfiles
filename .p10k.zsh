# Generated by Powerlevel10k configuration wizard on 2021-10-31 at 21:32 GMT.
...
() {
  ...
  ################################[ prompt_char: prompt symbol ]################################
  # Blue prompt symbol if the last command succeeded. (I changed this from green)
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%198F'   # pink foreground
  ...
  ##############################[ node_version: node.js version ]###############################
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=39
  ...
  ################################[ battery: internal battery ]#################################
  # Show battery in pink when it's below this level and not connected to power supply.
  typeset -g POWERLEVEL9K_BATTERY_LOW_THRESHOLD=20
  typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND=198
